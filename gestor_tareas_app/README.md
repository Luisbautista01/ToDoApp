...
Proyecto academico desarrollado para la asignatura de Tópicos avanzados de software.
...
|---|---|---|
| ![Login](lib/assets/images/login.svg) | ![Registro](lib/assets/images/signup.svg) | ![Recuperacion](lib/assets/images/forgot_password.svg) |
...
La app permite clasificar tareas por categoria y prioridad para facilitar la organizacion. En la interfaz se usan colores, chips visuales, filtros y agrupacion por fecha para identificar rapidamente el estado de cada actividad.
